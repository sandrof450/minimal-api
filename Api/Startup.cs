...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddScoped<IAdministradorServico, AdministradorServicos>();
        services.AddScoped<IVeiculoSevico, VeiculoServico>();
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapPost("/veiculos", ([FromBody] VeiculoDTO veiculoDTO, IVeiculoSevico veiculoSevico) =>
            {
            ...
            endpoints.MapGet("/veiculos", ([FromQuery] int? pagina, IVeiculoSevico veiculoServico) =>
            {
            ...
            endpoints.MapGet("/veiculos/{id}", ([FromRoute] int id, IVeiculoSevico veiculoSevico) =>
            {
            ...
            endpoints.MapPut("/veiculos/{id}", ([FromRoute] int id, VeiculoDTO veiculoDTO, IVeiculoSevico veiculoSevico) =>
            {
                var validacao = validaDTO(veiculoDTO);
            ...
            endpoints.MapDelete("/veiculos/{id}", ([FromRoute] int id, IVeiculoSevico veiculoSevico) =>
            {
                var veiculo = veiculoSevico.BuscarPorId(id);
                if (veiculo == null) return Results.NotFound();
